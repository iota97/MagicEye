...
magiceye: glad.o imgui_impl_opengl3.o imgui_impl_glfw.o imgui.o imgui.o imgui_draw.o imgui_tables.o imgui_widgets.o main.o  
	$(CXX) -o $(TARGET) imgui_impl_opengl3.o imgui_impl_glfw.o glad.o main.o imgui.o imgui_draw.o imgui_tables.o imgui_widgets.o $(LDFLAGS)

.PHONY : clean
clean :
	-rm main.o glad.o imgui.o imgui_draw.o imgui_tables.o imgui_widgets.o imgui.ini imgui_impl_opengl3.o imgui_impl_glfw.o $(TARGET)

main.o: main.cpp ./ext/stb_image/stb_image.h
